<?php
    ...
    if (!$studentId) {
        die("ID studente non specificato.");
    }

    // Recupera nome dello studente
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if($row['note'] !== ""){
            // Nota
            $event['description'] = "📝 Nota presente";
        }
...
<body class="bg-light">
    ...
    <div class="container mt-4">
        <h2 class="mb-4">📅 Previsioni di <?= htmlspecialchars($student['full_name']) ?></h2>
        ...
        <a href="students_forecasts.php" class="btn btn-secondary">← Torna all'elenco studenti</a>
    </div>
    <script>
