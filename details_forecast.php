...
<body class="bg-light">
    ...
    <div class="container mt-2">
        ...
        <?php
            if ($user['full_name'] !== $fullNameForecaster) {
                echo '<a href="student_forecast_details.php?id=' . urlencode($forecast['user_id']) . '" class="btn btn-secondary mt-3">← Torna alle previsioni dello studente</a>';
            } else {
                echo '<a href="history_forecast.php" class="btn btn-secondary mt-3">← Torna alla tua cronologia</a>';
            }
        ?>
